...
const BottomNav = () => {
    ...
    const navItems = [
        ...
        { icon: 'g_translate', label: 'Tradutor', path: '/calls' },
    ...
    return (
        <nav className="fixed bottom-0 left-0 right-0 z-50 flex items-center justify-around px-2 py-3 bg-background-light/95 dark:bg-background-dark/95 border-t border-primary/20 backdrop-blur-lg pb-[calc(1rem+env(safe-area-inset-bottom))] pt-3">
