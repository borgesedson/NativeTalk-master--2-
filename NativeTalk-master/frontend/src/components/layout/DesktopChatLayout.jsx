...
const DesktopChatLayout = ({
    ...
    return (
        <div className="flex h-[100dvh] w-full bg-background-dark text-slate-100 overflow-hidden font-display">
            ...
            {/* 1. Navigation Sidebar (Left - 80px) - Hidden on Mobile, Hidden on Tablet */}
            <div className="w-[80px] shrink-0 bg-[#0A1A2F] flex-col items-center py-6 hidden lg:flex border-r border-[#1E2A3A] z-20 shadow-xl backdrop-blur-md">
                {navigationSidebar}
            </div>
