...
define(['./workbox-043c2378'], (function (workbox) { 'use strict';
  ...
  workbox.registerRoute(/^http.*\/api\/.*/i, new workbox.NetworkFirst({
    "cacheName": "api-cache",
  ...
  workbox.registerRoute(/^https:\/\/.*\.stream-io-api\.com\/.*/i, new workbox.NetworkFirst({
  ...
  workbox.registerRoute(/^https:\/\/avatar\.iran\.liara\.run\/.*/i, new workbox.NetworkFirst({
